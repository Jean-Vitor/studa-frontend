        ...
        <ScrollView>
            <View style={[styles['main-container'], styles['container-wrapper']]}>
                ...
                <View style={styles['timer-type']}>
                    <TouchableOpacity onPress={() => navigate('Timer1')} activeOpacity={0.5}>
                        <Text style={[styles['font-default'], styles['type-text']]}>Pomodoro</Text>
                    </TouchableOpacity>

                    <TouchableOpacity activeOpacity={1}>
                        <Text style={[styles['font-default'], styles['type-text'], styles['typeSelected']]}>Short break</Text>
                    </TouchableOpacity>
